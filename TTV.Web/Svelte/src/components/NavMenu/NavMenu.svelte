<script>
  ...
  import TestEnvironmentBanner from '$components/TestEnvironmentBanner.svelte';
</script>
  ...
  <div class="container">
    ...
    <div
      ...
      <div class="navbar-nav ms-md-auto">
        <NavLink href="/learning-path"><i class="bi bi-sign-turn-slight-left"></i> Learning Path</NavLink>
