...
{
    /// <inheritdoc />
    public partial class TTV_Add_Documents : Migration
    {
        /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LessonDocument", x => new { x.DocumentId, x.LessonId });
                    table.ForeignKey(
                        name: "FK_LessonDocument_Document_DocumentId",
            ...
            migrationBuilder.InsertData(
                table: "DocumentType",
                columns: new[] { "Id", "Name" },
                values: new object[] { 1, "Exercise PDF" });
