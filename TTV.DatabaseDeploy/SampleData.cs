...
namespace TTV.DatabaseDeploy
{
    internal class SampleData
    {
        ...
        private static Video[] LessonVideos { get; } = new Video[25]
        {
            ...
            new Video() { Id = 29, Filename = $"{Lessons[3].Title}.mp4", Thumbnail = $"{Lessons[3].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[3] },
            new Video() { Id = 30, Filename = $"{Lessons[4].Title}.mp4", Thumbnail = $"{Lessons[4].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[4] },
            new Video() { Id = 31, Filename = $"{Lessons[5].Title}.mp4", Thumbnail = $"{Lessons[5].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[5] },
            new Video() { Id = 32, Filename = $"{Lessons[6].Title}.mp4", Thumbnail = $"{Lessons[6].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[6] },
            new Video() { Id = 33, Filename = $"{Lessons[7].Title}.mp4", Thumbnail = $"{Lessons[7].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[7] },
            new Video() { Id = 34, Filename = $"{Lessons[8].Title}.mp4", Thumbnail = $"{Lessons[8].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[8] },
            new Video() { Id = 35, Filename = $"{Lessons[9].Title}.mp4", Thumbnail = $"{Lessons[9].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[9] },
            new Video() { Id = 36, Filename = $"{Lessons[10].Title}.mp4", Thumbnail = $"{Lessons[10].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[10] },
            new Video() { Id = 37, Filename = $"{Lessons[11].Title}.mp4", Thumbnail = $"{Lessons[11].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[11] },
            new Video() { Id = 38, Filename = $"{Lessons[12].Title}.mp4", Thumbnail = $"{Lessons[12].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[12] },
            new Video() { Id = 39, Filename = $"{Lessons[13].Title}.mp4", Thumbnail = $"{Lessons[13].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[13] },
            new Video() { Id = 40, Filename = $"{Lessons[14].Title}.mp4", Thumbnail = $"{Lessons[14].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[14] },
            new Video() { Id = 41, Filename = $"{Lessons[15].Title}.mp4", Thumbnail = $"{Lessons[15].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[15] },
            new Video() { Id = 42, Filename = $"{Lessons[16].Title}.mp4", Thumbnail = $"{Lessons[16].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[16] },
            new Video() { Id = 43, Filename = $"{Lessons[17].Title}.mp4", Thumbnail = $"{Lessons[17].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[17] },
            new Video() { Id = 44, Filename = $"{Lessons[18].Title}.mp4", Thumbnail = $"{Lessons[18].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[18] },
            new Video() { Id = 45, Filename = $"{Lessons[19].Title}.mp4", Thumbnail = $"{Lessons[19].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[19] },
            new Video() { Id = 46, Filename = $"{Lessons[20].Title}.mp4", Thumbnail = $"{Lessons[20].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[20] },
            new Video() { Id = 47, Filename = $"{Lessons[21].Title}.mp4", Thumbnail = $"{Lessons[21].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[21] },
