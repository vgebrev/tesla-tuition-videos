...
namespace TTV.DatabaseDeploy
{
    internal class SampleData(DataContext dataContext)
    {
        ...
        [
            ...
            new Video() { Id = 43, Filename = $"{Lessons[5].Title}.mp4", Thumbnail = $"{Lessons[5].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[5], Duration = new TimeSpan(0, 34, 09) },
            new Video() { Id = 44, Filename = $"{Lessons[6].Title}.mp4", Thumbnail = $"{Lessons[6].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[6], Duration = TimeSpan.Zero },
            ...
            new Video() { Id = 48, Filename = $"{Lessons[10].Title}.mp4", Thumbnail = $"{Lessons[10].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[10], Duration = new TimeSpan(0, 22, 20) },
            new Video() { Id = 49, Filename = $"{Lessons[11].Title}.mp4", Thumbnail = $"{Lessons[11].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[11], Duration = new TimeSpan(1, 6, 59) },
            new Video() { Id = 50, Filename = $"{Lessons[12].Title}.mp4", Thumbnail = $"{Lessons[12].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[12], Duration = TimeSpan.Zero },
            new Video() { Id = 51, Filename = $"{Lessons[13].Title}.mp4", Thumbnail = $"{Lessons[13].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[13], Duration = TimeSpan.Zero },
            new Video() { Id = 52, Filename = $"{Lessons[14].Title}.mp4", Thumbnail = $"{Lessons[14].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[14], Duration = new TimeSpan(0, 45, 32) },
            ...
            new Video() { Id = 55, Filename = $"{Lessons[17].Title}.mp4", Thumbnail = $"{Lessons[17].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[17], Duration = TimeSpan.Zero },
            // Chemistry
            new Video() { Id = 56, Filename = $"{Lessons[18].Title}.mp4", Thumbnail = $"{Lessons[18].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[18], Duration = TimeSpan.Zero },
            new Video() { Id = 57, Filename = $"{Lessons[19].Title}.mp4", Thumbnail = $"{Lessons[19].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[19], Duration = TimeSpan.Zero },
            ...
            new Video() { Id = 61, Filename = $"{Lessons[23].Title}.mp4", Thumbnail = $"{Lessons[23].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[23], Duration = TimeSpan.Zero },
            new Video() { Id = 62, Filename = $"{Lessons[24].Title}.mp4", Thumbnail = $"{Lessons[24].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[24], Duration = TimeSpan.Zero },
            new Video() { Id = 63, Filename = $"{Lessons[25].Title}.mp4", Thumbnail = $"{Lessons[25].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[25], Duration = TimeSpan.Zero },
            new Video() { Id = 64, Filename = $"{Lessons[26].Title}.mp4", Thumbnail = $"{Lessons[26].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[26], Duration = TimeSpan.Zero },
            new Video() { Id = 65, Filename = $"{Lessons[27].Title}.mp4", Thumbnail = $"{Lessons[27].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[27], Duration = TimeSpan.Zero },
            new Video() { Id = 66, Filename = $"{Lessons[28].Title}.mp4", Thumbnail = $"{Lessons[28].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[28], Duration = TimeSpan.Zero },
            new Video() { Id = 67, Filename = $"{Lessons[29].Title}.mp4", Thumbnail = $"{Lessons[29].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[29], Duration = TimeSpan.Zero },
            new Video() { Id = 68, Filename = $"{Lessons[30].Title}.mp4", Thumbnail = $"{Lessons[30].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[30], Duration = TimeSpan.Zero },
            new Video() { Id = 69, Filename = $"{Lessons[31].Title}.mp4", Thumbnail = $"{Lessons[31].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[31], Duration = TimeSpan.Zero },
            new Video() { Id = 70, Filename = $"{Lessons[32].Title}.mp4", Thumbnail = $"{Lessons[32].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[32], Duration = TimeSpan.Zero },
            new Video() { Id = 71, Filename = $"{Lessons[33].Title}.mp4", Thumbnail = $"{Lessons[33].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[33], Duration = TimeSpan.Zero },
            new Video() { Id = 72, Filename = $"{Lessons[34].Title}.mp4", Thumbnail = $"{Lessons[34].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[34], Duration = TimeSpan.Zero },
            new Video() { Id = 73, Filename = $"{Lessons[35].Title}.mp4", Thumbnail = $"{Lessons[35].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[35], Duration = TimeSpan.Zero },
            new Video() { Id = 74, Filename = $"{Lessons[36].Title}.mp4", Thumbnail = $"{Lessons[36].Title}.jpg", VideoType = VideoType.FullLesson, Lesson = Lessons[36], Duration = TimeSpan.Zero },
        ];
